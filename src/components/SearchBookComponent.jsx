...
//         return `http://localhost:8080/api/images/${encodedImageName}`;
//     };
//
//     return (
//         <div className="container">
...
//                     <th>Book Price</th>
//                     <th>Book Description</th>
//                     <th>Book Image</th> {/* Updated to show the image */}
//                     <th>Book Rating</th>
//                     <th>Book Inventory Count</th>
//                 </tr>
//                 </thead>
        ...
        <div className="container">
            ...
            <div>
                ...
                <select value={searchCriteria.sort} onChange={handleSortColumnChange}>
                    ...
                    <option value="rating">Rating</option> {/* Sort by rating */}
                </select>
                <button onClick={handleSearch}>Search</button>
            </div>
            <div>
