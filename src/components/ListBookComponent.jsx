...
// import React, { useEffect, useState } from "react";
// import { listBooks, getImage, searchBooks } from "../sevices/BookService.js";
// import { useNavigate } from 'react-router-dom';
//
// const ListBookComponent = () => {
//     const [books, setBooks] = useState([]);
...
//         try {
//             const response = await searchBooks({ sort: "price" });
//             setBooks(response.data);
//         } catch (error) {
...
//         try {
//             const response = await searchBooks({ sort: "rating" });
//             setBooks(response.data);
//         } catch (error) {
...
//             <h2 className='text-center'>List of Books</h2>
//             <button className='btn btn-primary mb-2' onClick={() => navigator('/books/add-book')}>Add Book</button>
//             <button className='btn btn-primary mb-2' onClick={handleSortByPrice}>Sort by Price</button>
//             <button className='btn btn-primary mb-2' onClick={handleSortByRating}>Sort by Rating</button>
//             <button className='btn btn-primary mb-2' onClick={() => navigator('/books/sort')}>Sort</button>
//             <table className='table table-striped table-bordered'>
//                 <thead>
//                 <tr>
